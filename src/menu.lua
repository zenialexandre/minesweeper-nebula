...
function menu:started()
    local title_font = nebula.graphics.newFont("resources/fonts/RobotoMono-Italic.ttf", 25.0)
    local enter_call_font = nebula.graphics.newFont("resources/fonts/RobotoMono-Italic.ttf", 15.0)
